...
var MusicItem = React.createClass({
    ...
    showMenu: function(e){
        this.props.showOnTop({x: e.pageX, y: e.pageY}, this.props.meta);
    },
    render: function(){
        return (
...
var ItemMenu = React.createClass({
    ...
    render: function(){
        return(
            <span>
                <div id="optsItem">
                    <span className="oneOpt" onClick={this.showOnTop}><img src="img/ic_file_download_black_24dp.png" alt="dl" className="imgOpt"/><span className="txtOpt">Download</span></span>
